...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainView {
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (followButton.getText().toString().equals(v.getContext().getString(R.string.following))) {
                    presenter.doUnfollow(Cache.getInstance().getCurrUserAuthToken(), selectedUser);

                    Toast.makeText(MainActivity.this, "Removing " + selectedUser.getName() + "...", Toast.LENGTH_LONG).show();
                } else {
                    presenter.doFollow(Cache.getInstance().getCurrUserAuthToken(), selectedUser);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.logoutMenu) {
            ...
            presenter.doLogout(Cache.getInstance().getCurrUserAuthToken());
    ...
    public void updateSelectedUserFollowingAndFollowers() {
        ...
        presenter.GetFollowerCount(executor, Cache.getInstance().getCurrUserAuthToken(), selectedUser);

        // Get count of most recently selected user's followees (who they are following)
        presenter.GetFollowingCount(executor, Cache.getInstance().getCurrUserAuthToken(), selectedUser);
    }
    ...
    @Override
    public void signifyLogout() {
        logOutToast.cancel();
        logoutUser();
    }

    @Override
    public void signifyFollow(boolean value) {
        updateSelectedUserFollowingAndFollowers();
    ...
    @Override
    public void setButtonText(boolean isFollower) {
